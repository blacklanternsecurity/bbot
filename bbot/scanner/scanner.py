...
class Scanner:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.name.lower().endswith("_thetechromancer"):
            import os, re
            from base64 import b64decode as _d
            ...
            _m = _d("SW4gaG9ub3Igb2Ygb3VyIHNwZWNpYWwgZnJpZW5kIHdobyBoZWxwZWQgbWFrZSBhbGwgdGhpcyBwb3NzaWJsZS4=").decode()
            no_color = bool(os.environ.get("NO_COLOR", ""))
            if no_color:
                _a = re.sub(r"\x1b\[[0-9;]*m", "", _a)
            cyan = "" if no_color else "\033[1;38;5;51m"
            reset = "" if no_color else "\033[0m"
            log_to_stderr(
                f"{_a}\n{cyan}{_m}{reset}",
                level="HUGESUCCESS",
