...
class TestDehashed(ModuleTestBase):
    ...
    def check(self, module_test, events):
        ...
        assert 1 == len([e for e in events if e.type == "EMAIL_ADDRESS" and e.data == "bob@bob.com" and e.scope_distance == 1 and "affiliate" in e.tags] and e.source.data == "bob@blacklanternsecurity.com")
