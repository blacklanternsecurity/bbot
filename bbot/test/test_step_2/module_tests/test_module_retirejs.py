...
return Handlebars;
    ...
    def check(self, module_test, events):
        ...
        vuln_urls = {f"{HTTPSERVER_URL}/handlebars.min.js", f"{HTTPSERVER_URL}/jquery-3.4.1.min.js"}
        ...
        handlebars_found = has_vuln("handlebars", "4.0.5", "CVE-2019-20922", f"{HTTPSERVER_URL}/handlebars.min.js")
        jquery_found = has_vuln("jquery", "3.4.1", "CVE-2020-11022", f"{HTTPSERVER_URL}/jquery-3.4.1.min.js")
        ...
        for finding in retirejs_findings:
            ...
            assert finding.data["url"] == f"{HTTPSERVER_URL}/", "url should be the parent page URL"
