...
class web_report(BaseOutputModule):
    ...
    class Config(BaseModuleConfig):
        ...
        css_theme_file: str = Field('https://cdnjs.cloudflare.com/ajax/libs/github-markdown-css/5.1.0/github-markdown.min.css', description='CSS theme URL for HTML output')
