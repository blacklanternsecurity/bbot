...
class naabu(BaseModule):
    ...
    watched_events = ['IPV4_ADDRESS', 'IPV6_ADDRESS', 'IPV4_RANGE', 'IPV6_RANGE', 'DOMAIN', 'SUBDOMAIN']
    ...
    def handle_batch(self, *events):
        ...
        proc = subprocess.Popen(command, stderr=subprocess.DEVNULL, stdout=subprocess.PIPE)
        while 1:
