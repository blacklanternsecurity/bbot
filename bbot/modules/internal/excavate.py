            ...
            if self.parameter_extraction is True:
                ...
                for custom_cookie_name, custom_cookie_value in custom_cookies.items():
                    ...
                    data = {
                        ...
                        "original_value": str(custom_cookie_value) if custom_cookie_value is not None else None,
                ...
                for custom_header_name, custom_header_value in custom_headers.items():
                    ...
                    data = {
                        ...
                        "original_value": str(custom_header_value) if custom_header_value is not None else None,
                        ...
                        if "=" not in header_value:
                            ...
                            if self.in_bl(cookie_name) is False:
                                ...
                                data = {
                                    ...
                                    "type": "COOKIE",
                                    "name": cookie_name,
                                    "original_value": str(cookie_value) if cookie_value is not None else None,
                                    "url": self.url_unparse("COOKIE", event.parsed_url),
                                    "description": description,
                                }
