...
If you get errors resembling any of the above, it's probably because your Python version is too old. To install a newer version (3.11+ is required), you will need to do something like this:
```bash
...
reboot
# install bbot
python3.11 -m pipx install bbot
# run bbot
bbot --help
```
