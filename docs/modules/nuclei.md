...
| modules.nuclei.etypes         | str                                                 | protocol types to exclude from the scan, comma-separated (dns, file, http, headless, tcp, workflow, ssl, websocket, whois, code, javascript)                                                                                                                                                                                   |           |
